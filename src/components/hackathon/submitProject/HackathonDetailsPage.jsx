        ...
        <div className="shadow-md bg-white p-8  border rounded-md">
          ...
          <div className="mt-[80px] ml-[30px]">
            <div className="flex flex-row gap-[150px]">
              <div className="border-gray-400  w-[450px] h-[250px] border rounded-md  gap-10 px-5">
              ...
              <div className="flex flex-col gap-5">
                <div className="border-gray-400 w-[200px] h-[80px] border rounded-md px-3 py-2 flex flex-row gap-10">
