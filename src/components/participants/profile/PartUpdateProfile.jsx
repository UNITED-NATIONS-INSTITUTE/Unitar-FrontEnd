...
const PartUpdateProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        setIsModalOpen(false); // Close the modal after the timeout
        navigate("/participant/profile"); // Navigate to the desired location
      }, 2000);
    } catch (error) {
      console.log(error);
...
export default PartUpdateProfile;
